...
export default function AddEditMenuModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-card w-full max-w-[520px] rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200 border border-border" onClick={(e) => e.stopPropagation()}>
